...
var _user$project$State$subscriptions = function (model) {
	return A2(_debois$elm_mdl$Material_Layout$subs, _user$project$Types$Mdl, model.mdl);
};
		...
		switch (_p0.ctor) {
			...
			case 'Refresh':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{projects: _elm_lang$core$Maybe$Nothing, developers: _elm_lang$core$Maybe$Nothing}),
					_1: _user$project$Api$fetchIndex
				};
			case 'IndexFetched':
				if (_p0._0.ctor === 'Ok') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								projectsEndpoint: _elm_lang$core$Maybe$Just(_p2),
								developersEndpoint: _elm_lang$core$Maybe$Just(_p1)
							}),
						{
							ctor: '::',
							_0: _user$project$Api$fetchProjects(_p2),
							_1: {
								ctor: '::',
								_0: _user$project$Api$fetchDevelopers(_p1),
								_1: {ctor: '[]'}
							}
						});
				} else {
				...
				if (_p0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								developers: _elm_lang$core$Maybe$Just(_p0._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _user$project$State$init = A2(
	...
	_user$project$State$initialModel,
	{
		...
		_1: {
			ctor: '::',
			_0: _user$project$Api$fetchIndex,
			_1: {ctor: '[]'}
		}
	});
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		{
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Developers'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		function () {
			var _p0 = model.developers;
			if (_p0.ctor === 'Just') {
				return A2(_elm_lang$core$List$map, _user$project$View$developerItemHtml, _p0._0);
			} else {
				return {
					ctor: '::',
								...
								_0: A5(
									...
									model.mdl,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Types$Refresh),
												_1: {ctor: '[]'}
											}
										}
									},
									{
										ctor: '::',
										_0: _debois$elm_mdl$Material_Icon$i('refresh'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
