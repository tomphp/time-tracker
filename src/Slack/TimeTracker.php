...
class TimeTracker
{
    ...
    public function fetchDeveloperById(Common\DeveloperId $id) : Developer
    {
        $developer = $this->developers->withId(Tracker\DeveloperId::fromString((string) $id));
    ...
    {
        return $this->projects->hasWithName($name);
    }
